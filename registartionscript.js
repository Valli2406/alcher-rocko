...
function addMember() {
    ...
    // Get the container where member details will be added (inside the same section as Leader Details)
    const detailsContainer = document.querySelector('.teamdetails');

    // Create a new member section
    ...
    // Append the new member section inside the teamdetails container
    detailsContainer.appendChild(memberDiv);

    // Add the functionality for the remove button inside the newly created member
